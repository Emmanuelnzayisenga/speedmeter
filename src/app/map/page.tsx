...
import { ZoneEditorMap } from '@/components/map/ZoneEditorMap'
...
import {
  Plus, Edit, Trash2, MapPin, Circle, Hexagon, RefreshCw,
  AlertTriangle, ToggleLeft, ToggleRight, Gauge, Info
} from 'lucide-react'
      ...
      <div className="flex h-full">
        ...
        <div className="w-72 border-r border-border/50 flex flex-col bg-sw-panel/50 flex-shrink-0">
          ...
          <div className="p-3 border-b border-border/50">
            ...
            {drawMode && (
              <div className="mt-2 px-2.5 py-2 rounded-md bg-primary/10 border border-primary/20 flex items-start gap-2">
                        ...
                        <div className="flex items-center justify-between gap-1">
                          ...
                          <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                            <button onClick={(e) => { e.stopPropagation(); toggleActive(zone) }} className="text-muted-foreground hover:text-foreground">
                              {zone.active
                                ? <ToggleRight className="w-3.5 h-3.5 text-sw-safe" />
      ...
      <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
        <DialogContent className="max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>
              {editingZone ? 'Update zone configuration' : `Configure the new ${pendingType?.toLowerCase()} zone`}
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="space-y-4 py-2">
            <div className="space-y-1.5">
              ...
              <Input placeholder="e.g. Nairobi CBD" value={form.name}
